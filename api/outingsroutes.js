...
router.post("/createOuting", async (req, res) => {
    ...
    try {
        outing = await outingData.initOuting(friend, currentUser, req.body.userRole, req.body.friendRole, req.body.date);
...
router.get("/getRestaurants", async (req, res) => {
    ...
    const options = {
        ...
        headers: {
            ...
            Authorization: 'Bearer ZSTg3rjsJHqKdwiy_rW0W_Wvic2g2HwuEkx6OM70vu5jMsd3yhcaVEVfQMJCmP0_F9u9cbO679uiDgrlWZc8e-eJpPYQDDOiJNpTvIl0KFec3-DfqxXwxicqmTdRZHYx'
        }
    };
